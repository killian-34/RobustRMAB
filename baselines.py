...
class HawkinsAgentPolicy:
    ...
    def act_test(self, o, just_hawkins_lambda=False):
        ...
        L_vals, lambda_val, obj_val = lp_methods.hawkins(self.T, self.R, self.C, self.B, current_state, lambda_lim=lambda_lim, gamma=self.gamma)
        ...
        decision_matrix = lp_methods.action_knapsack(indexes_per_state, self.C, self.B)
