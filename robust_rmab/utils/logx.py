...
import warnings
from robust_rmab.utils.mpi_tools import proc_id, mpi_statistics_scalar
from robust_rmab.utils.serialization_utils import convert_json
...
class Logger:
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None):
        ...
        if proc_id()==0:
            ...
            print('exists:',osp.exists(self.output_dir))
